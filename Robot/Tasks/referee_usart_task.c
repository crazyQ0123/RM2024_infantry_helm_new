...
void referee_usart_task(void const * argument)
{
    ...
    UI_Capacitance=cap_data.cap_per * 100;
		...
		if(KEYB_FLASH_UI)
		{
			...
			UI_Draw_Rectangle(&UI_Graph7.Graphic[4], "207", UI_Graph_Add, 2, UI_Color_Purple, 2, 900, 480, 1020,600);			 	//自瞄框
...
//			osDelay(UI_UPDATE_DELAY);
		...
		if(UI_lock_mode	!=	UI_lock_flag ) //动态UI更新 Lock
		{
			...
			{
				UI_Operate=UI_Graph_Add;
				UI_Draw_Rectangle(&UI_Graph2.Graphic[1], "207", UI_Graph_Change, 2, UI_Color_Purple, 2, 900, 480, 1020,600);	 //自瞄框
			...
			{
				UI_Operate=UI_Graph_Delete;
				UI_Draw_Rectangle(&UI_Graph2.Graphic[1], "207", UI_Graph_Change, 2, UI_Color_White, 2, 900, 480, 1020,600);	 //自瞄框
